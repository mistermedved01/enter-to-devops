...
✅ **kube-apiserver** — центральный компонент control plane, единственный интерфейс к ETCD

✅ **Основные функции:**
- Единственный интерфейс к ETCD
- Центральный координатор всех операций
- Аутентификация и авторизация всех запросов
- Валидация конфигураций ресурсов
- Масштабируемость — поддержка нескольких экземпляров
