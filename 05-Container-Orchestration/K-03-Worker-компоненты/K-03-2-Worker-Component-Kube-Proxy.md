...
✅ **kube-proxy** — сетевой прокси, обеспечивающий работу Service abstraction

✅ **Основные принципы:**
- Сетевой прокси — обеспечивает работу Service abstraction
- На каждой ноде — работает как DaemonSet
- Правила маршрутизации — использует iptables/ipvs
- Балансировка нагрузки — распределяет трафик между Pod'ами
- Динамическое обновление — отслеживает изменения сервисов
