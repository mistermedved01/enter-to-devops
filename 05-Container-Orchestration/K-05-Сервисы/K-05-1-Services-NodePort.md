...
✅ **NodePort Service** — тип Service для внешнего доступа через статические порты на всех нодах кластера
...
✅ **Best Practices:**
- Используйте осмысленные селекторы
- Минимальные привилегии портов
- Используйте автоматические nodePort если не нужен конкретный порт
- Тестируйте со всех нод
- Для продакшена рассмотрите LoadBalancer или Ingress
