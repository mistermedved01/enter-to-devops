...
- **[K-09-1-Rolling-Updates-and-Rollbacks](K-09-1-Rolling-Updates-and-Rollbacks.md)** — обновления и откаты **← Текущая тема**
...
В следующей теме [K-09-2-Command-and-Arguments-Docker](K-09-2-Command-and-Arguments-Docker.md) мы рассмотрим, как определяются команды и аргументы в Docker контейнерах, изучим разницу между CMD и ENTRYPOINT, и научимся переопределять команды при запуске контейнеров.
