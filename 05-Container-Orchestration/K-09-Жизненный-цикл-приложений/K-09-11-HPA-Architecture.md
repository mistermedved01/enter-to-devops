...
- **[K-09-11-HPA-Architecture](K-09-11-HPA-Architecture.md)** — архитектура Horizontal Pod Autoscaler **← Текущая тема**
...
В следующей теме [K-09-12-VPA-Architecture](K-09-12-VPA-Architecture.md) мы рассмотрим архитектуру Vertical Pod Autoscaler, изучим компоненты VPA, режимы обновления и механизмы автоматической оптимизации ресурсов контейнеров.
