...
- **[K-09-10-Autoscaling-Benefits](K-09-10-Autoscaling-Benefits.md)** — преимущества автоматического масштабирования **← Текущая тема**
...
В следующей теме [K-09-11-HPA-Architecture](K-09-11-HPA-Architecture.md) мы рассмотрим архитектуру Horizontal Pod Autoscaler, изучим компоненты HPA, типы метрик и механизмы горизонтального масштабирования приложений.
