...
**Что происходит:**
- ❌ Pod'ы БЕЗ toleration НЕ будут назначены на узел
- ✅ Pod'ы С toleration МОГУТ быть назначены на узел
...
**Что происходит:**
- ❌ Pod'ы БЕЗ toleration НЕ будут назначены на узел
- 🗑️ Существующие Pod'ы БЕЗ toleration БУДУТ УДАЛЕНЫ
