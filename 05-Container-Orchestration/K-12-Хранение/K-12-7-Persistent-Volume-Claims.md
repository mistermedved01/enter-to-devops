...
- **[K-12-8-Storage-Classes](K-12-8-Storage-Classes.md)** — Storage Classes, динамическая подготовка томов

---

## Что дальше?

В следующей теме [K-12-8-Storage-Classes](K-12-8-Storage-Classes.md) мы рассмотрим Storage Classes — механизм динамического выделения хранилища, который автоматизирует создание PV при создании PVC.
