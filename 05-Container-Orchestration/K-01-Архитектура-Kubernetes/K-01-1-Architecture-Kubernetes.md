...
✅ **Kubernetes** — платформа для оркестрации контейнеров с декларативным управлением

✅ **Ключевые принципы:**
- Декларативность — описываем "что", а не "как"
- Самовосстановление — автоматическое поддержание состояния
- Масштабируемость — легко увеличить/уменьшить нагрузку
- Переносимость — одинаково работает везде
- Модульность — компоненты независимы и заменяемы
